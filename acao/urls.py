...
urlpatterns = [
   ...
   url(r'^login/$', "acao.views.go_to_login"),
   url(r'^auth/$', "acao.views.authentic_user"),
   url(r'^logout/$', "acao.views.logout_user"),
   ...
   url(r'^parlamentar/(?P<id_parlamentar>[0-9]+)/comissoes/$', "acao.views.detail_parlamentar_comissoes"),
   url(r'^parlamentar/(?P<id_parlamentar>[0-9]+)/frentes/$', "acao.views.detail_parlamentar_frentes"),
   ...
   url(r'^comissao/(?P<id_comissao>[0-9]+)/parlamentares/$', "acao.views.detail_comissao_parlamentares"),
